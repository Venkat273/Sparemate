    ...
    <div
      ...
      <div class="d-flex align-items-center justify-content-center w-100">
        <div class="row justify-content-center w-100">
          <div class="col-md-8 col-lg-16 col-xxl-3">
            <div class="card mb-0">
              <div class="card-body">
               <br><br><br><br><br>
                ...
                <form action="emp_register.php" method="POST">
                  <div class="mb-3">
                    ...
                    <input type="text" name="name" class="form-control"  aria-describedby="textHelp">
                  </div>
                  <div class="mb-3">
                  ...
                  <!-- <div class="mb-4">
                    <label for="exampleInputPassword1" class="form-label">Employee Type</label>
                    <input type="text" class="form-control" >
                  </div> -->
                  <!-- <a href="./index.html" class="btn btn-primary w-100 py-8 fs-4 mb-4 rounded-2">Add Employee</a> -->
                 <input type="submit"  class="btn btn-primary w-100 py-8 fs-4 mb-4 rounded-2" value="Add Employee">
                </form>
              </div>
            </div>
          </div>
