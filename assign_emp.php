...
<link href="form/css/style.css" type="text/css" rel="stylesheet" media="all">   
<!-- //css files -->

<link rel="stylesheet" href="form/css/font-awesome.css"> 
	...
	<div class="register-full">
		<div class="register-left">
			<div class="register">
				...
				<div class="content3">
					<ul>
						<li><a class="" href="admin_home.php">Home</a></li>
						<li><a class="read" href="emp_details.php">Employee Details</a></li>
					</ul>
				</div>
			</div>
		</div>
		<div class="register-right">
			<div class="register-in">
				<h2><span class="fa fa-pencil"></span> Assign Employee</h2>
