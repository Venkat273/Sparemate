...
<div class="cart"><h2 class="cart-text">MY CART</h2></div>
<div class="row" style="margin-left:60px;">
  ...
  <?php
        ...
        $query = "SELECT ov.id, ov.brand, ov.product_name, ov.parts, ov.image_data FROM overall ov INNER JOIN cart ca ON ca.product_id = ov.id WHERE ca.user_id= $user_id";
  ...
  $result = $conn->query($query);
      ...
      echo          '<div class="inner">';
       ...
       echo          ' <a class="btn btn-outline-primary btn-sm" style="background-color: #F7C910; color:black; width:100%;" href="btyrecom.php?id='.$id.'" data-abc="true">Buy Now</a>';
         echo     '</div>';
         echo   '</div>';
          echo '</div>';
}
