...
if($RequestMethod == "POST"){
    try {
        ...
        $emp_name = addslashes((trim($_REQUEST['emp_name'])));
       
        $Query      = "SELECT * FROM orders INNER JOIN signup ON orders.user_id = signup.id INNER JOIN overall ON orders.product_id = overall.id WHERE orders.assign='$emp_name';";
