...
if($RequestMethod == "POST"){
    try {
        ...
        $orderUser_id = addslashes((trim($_REQUEST['orderUser_id'])));
       
        $Query      = "SELECT * FROM orders INNER JOIN overall ON orders.product_id=overall.id WHERE orders.user_id=$orderUser_id;";
