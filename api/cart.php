...
if($RequestMethod == "POST"){
    try {
        ...
        $cartUser_id = addslashes((trim($_REQUEST['cartUser_id'])));
       
        $Query      = "SELECT * FROM cart INNER JOIN overall ON cart.product_id=overall.id  WHERE cart.user_id=$cartUser_id;";
